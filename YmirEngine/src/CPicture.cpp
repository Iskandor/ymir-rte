...
CPicture::CPicture(CSprite* asset, CObjectEntity* object_entity, double z_index) {
  this->asset = asset;
  this->object_entity = object_entity;
  this->z_index = z_index;
}

CPicture::CPicture(const CPicture& orig) {
...
void CPicture::OnRender(SDL_Surface* dest, SDL_Rect camera)
{
...
bool CPicture::operator <(CPicture& ent) {
