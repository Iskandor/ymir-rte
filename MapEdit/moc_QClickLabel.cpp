...
**
** Created: Fri Aug 22 19:41:23 2014
**      by: The Qt Meta Object Compiler version 63 (Qt 4.8.4)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "include/QClickLabel.h"
...
static const char qt_meta_stringdata_QClickLabel[] = {
    "QClickLabel\0\0clicked()\0"
};
...
const QMetaObjectExtraData QClickLabel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QClickLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_QClickLabel,
      qt_meta_data_QClickLabel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QClickLabel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QClickLabel))
